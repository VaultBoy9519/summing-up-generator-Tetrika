...
export const statusInfoTutor = (compensMessage) => {
  return {
    nonPupilReg: `отменен в связи с техническими неполадками со стороны ученика. За урок вам начислена компенсация${compensMessage}.
Ученику предоставлены все необходимые рекомендации, чтобы избежать неполадок с его стороны на будущих уроках.`,
    nonPupilIntro: `отменен в связи с техническими неполадками со стороны ученика. За урок вам начислена компенсация${compensMessage}.
Ученику предоставлены все необходимые рекомендации, чтобы избежать неполадок с его стороны на будущих уроках.`,
...
Ученику предоставлены все необходимые рекомендации, чтобы избежать неполадок с его стороны на будущих уроках.`,
    cancelBug: `отменен в связи с техническими неполадками со стороны платформы. За урок вам начислена компенсация${compensMessage}.`,
